...
save_file_path = r"N:/STUDY/natural laguage engineering/lab8/lab8/exampleOUTPUT.txt.txt" # Set this to the location of the file you wish to create/overwrite with the saved output.
